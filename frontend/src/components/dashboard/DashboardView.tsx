  ...
  return (
    <div className="space-y-5 md:space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-950">Текущее состояние</h2>
          <p className="mt-1 text-sm text-slate-500">Оперативная сводка по очереди, срочным исследованиям и ближайшим действиям</p>
        </div>
      </div>
