...
const DraftsModal: React.FC<DraftsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end justify-center bg-slate-950/50 p-0 backdrop-blur-sm md:items-center md:p-4">
      <div className="flex max-h-[92dvh] w-full flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl md:max-w-3xl md:rounded-3xl">
            ...
            <div className="space-y-3">
              {drafts.map((draft) => (
                <div
                  ...
                  className="rounded-2xl border border-slate-200 bg-white p-4 transition hover:-translate-y-0.5 hover:shadow-md hover:shadow-slate-200/70"
                >
                  <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div className="min-w-0">
                      ...
                      <div className="mt-3 grid grid-cols-2 gap-3 rounded-2xl bg-slate-50 p-3 text-sm md:grid-cols-4">
                        <div>
                    ...
                    <div className="grid grid-cols-1 gap-2 shrink-0 sm:grid-cols-2 md:flex md:items-center">
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-3 py-2.5 text-sm font-semibold text-white shadow-sm shadow-blue-200 transition hover:bg-blue-700"
                      >
                        Открыть
                      </button>
